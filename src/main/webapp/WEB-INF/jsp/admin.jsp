<%@ page import="com.java.lcy.Permission.Common.RequestHolder" %>
<%@ page import="com.java.lcy.Permission.Entity.SysUser" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <jsp:include page="/WEB-INF/jsp/backend_common.jsp"/>
</head>
...
<div id="navbar" class="navbar navbar-default">
    <div class="navbar-container">
        ...
        <div class="navbar-header pull-left">
            <a href="/admin/page" class="navbar-brand">
                <small>
            ...
            <ul class="nav ace-nav">
                <li class="light-blue dropdown-modal">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="/logout"> <i class="ace-icon fa fa-power-off"></i>
                                注销
                            </a>
                        </li>
                    </ul>
...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul class="nav nav-list">
            <li class="active">
                <a class="popstyle" href="/sys/user/page" target="_blank">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a class="popstyle" href="/sys/dept/dept" target="_blank">
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/role/role" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            角色管理
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/aclModule/acl" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            权限管理
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a class="popstyle" href="/config/config" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            全局配置管理
                        </a>
                        <b class="arrow"></b>
    ...
    <div class="main-content">
        <iframe id="innerFrame" src="/sys/dept/dept" width="99%" style="min-height: 768px;"></iframe>
    </div>
    <!-- /.main-content -->
